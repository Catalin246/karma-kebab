...
func main() {
	...
	if tableConnectionString == "" || blobConnectionString == "" || accountName == "" || accountKey == "" {
		log.Fatal("Error: Azure storage environment variables are not set")
	}
	...
	blobServiceClient, err := db.InitAzureBlobStorage(blobConnectionString, accountName, accountKey)
	if err != nil {
